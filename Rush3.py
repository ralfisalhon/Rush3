...
array.append(["NONE", 13, "C", [0], (16), (640,320), pink])
...
def getInfo(number):
	print "OWNER:", array[number][0], "  NUMBER:", array[number][1], "  TYPE:", array[number][2], "  TYPES INCLUDE:", array[number][3], "  ADJACENT TO:", array[number][4]
	print
